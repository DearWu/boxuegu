define(['bootsrap', 'aside', 'header', 'loading', 'nprogress', 'jquery', 'template', 'bootstrap'], function (undefined, undefined, undefined, undefined, nprogress, $, template, undefined) {
    //渲染讲师列表
    (function () {
        /**
         * 1、发送请求获取讲师列表
